...
O arquivo "agent.py" é o orquestador de todo o funcionamento do projeto, logo, ele pode ser adaptado para qualquer tipo de interface facilmente, sem nenhuma edição no código (incluindo bots do Discord). O arquivo "main.py" foi criado apenas para que o agente seja acessível facilmente.
